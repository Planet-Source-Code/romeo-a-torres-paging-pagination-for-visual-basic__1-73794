...
Begin VB.Form f_Main 
   ...
   Begin VB.Label Top_Caption 
      ...
      Caption         =   "Romeo Angot Torres Paging/ Pagination"
      ForeColor       =   &H00808080&
      Height          =   255
      Left            =   120
      TabIndex        =   11
...
On Error GoTo Err_1
    ...
    With RS
        ...
        Do While Not .EOF And Temp_Counter < 13
            Set LI = LV_Results.ListItems.Add(, "K" & !Cur_ID, !Cur_ID)
        ...
        For y = 1 To Last_Page Step 5
            If Start_From + 1 >= y And Start_From + 1 <= y + 4 Then
                Exit For
            End If
        Next
